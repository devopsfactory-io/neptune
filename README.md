...
- **neptune-bot**: Trigger Neptune from PR open and @-mention comments by [installing the neptune-bot GitHub App](docs/github-app-and-lambda.md) and adding the workflow (recommended). To self-host, see [lambda/](lambda/) and [lambda/README.md](lambda/README.md).
